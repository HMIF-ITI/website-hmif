...
<body>
  ...
  <section id="hero-prestasi" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left hero-text-prestasi" data-aos="fade-up">
    ...
    <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4 p-5">
      <div class="col">
        <div class="card prestasi-card">
          <div class="card-body p-0"><img src="{{ asset('assets/image/card-prestasi-img.svg') }}" alt="" class="w-100 card-img-top prestasi-img">
            <div class="p-4">
