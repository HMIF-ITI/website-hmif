    ...
    <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4 p-5">
      <div class="col">
        <div class="card galeri-card">
          <div class="card-body p-0"><img src="{{ asset('assets/image/card-galeri-img.svg') }}" alt="" class="w-100 card-img-top galeri-img">
            <div class="p-4">
              <h5 class="mb-0 text-center card-title">Rapat PERMIKOMNAS Wilayah IV di Himpunan Teknik Informatika ITI 2023</h5>
            </div>
          </div>
        </div>
      </div>
