...
@section('content')
    ...
    <!-- Content Section -->
    <section class="flex flex-col gap-20 py-20 container my-5">
        ...
        <article class="bg-[#F5F7F9] py-10 px-8 lg:px-[116px] my-5">
            <div class="flex justify-between items-start md:items-center gap-8 md:flex-row flex-col">
            ...
            <div class="space-y-8 mt-8">
                ...
                <div class="flex gap-4 flex-wrap btndivisi">
                    <a href="#" class="btn btn-md py-2 px-4 rounded bg-[#FD6B04] text-white no-underline">Divisi
                        Media</a>
                    <a href="#" class="btn btn-md py-2 px-4 rounded bg-[#FD6B04] text-white no-underline">Divisi
                        Humas</a>
                </div>
        ...
        <article class="bg-[#F5F7F9] py-10 px-8 lg:px-[116px] my-5">
            ...
            <div class="space-y-8 mt-8">
                ...
                <div class="flex gap-4 lg:justify-end flex-wrap btndivisi">
                    <a href="#" class="btn btn-md py-2 px-4 rounded bg-[#FD6B04] text-white no-underline">Divisi
                        Akademis &
                        Litbang</a>
                    <a href="#" class="btn btn-md py-2 px-4 rounded bg-[#FD6B04] text-white no-underline">Divisi
